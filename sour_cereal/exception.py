'''Define all exceptions described on PEP 249'''
...
class Warning(StandardError):
    '''Exception raised for important warnings like data truncations while in-
    serting, etc.
    '''
    pass
...
class IntegrityError(DatabaseError):
    '''Exception raised when the relational integrity of the database is affec-
    ted, e.g. a foreign key check fails.'''
    pass
...
class ProgrammingError(DatabaseError):
    ...
    exists, syntax error in the SQL statement, wrong number of parameters spe-
    cified, etc.'''
    pass
